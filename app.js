...
(() => {
  ...
  const QUOTES = [
    ...
    { text: "Forget your opponents; always play against par.", who: "Sam Snead" },
    { text: "Golf is a game of inches. The most important are the six inches between your ears.", who: "Arnold Palmer" },
    { text: "Through years of experience I have found that air offers less resistance than dirt.", who: "Jack Nicklaus" },
    { text: "The harder I practice, the luckier I get.", who: "Gary Player" },
    { text: "If you watch a game, it's fun. If you play it, it's recreation. If you work at it, it's golf.", who: "Bob Hope" },
    { text: "I never pray on a golf course. Actually, the Lord answers my prayers everywhere except on the course.", who: "Billy Graham" },
    { text: "You swing your best when you have the fewest things to think about.", who: "Bobby Jones" },
    { text: "Don't be too proud to take lessons. I'm not.", who: "Jack Nicklaus" },
    { text: "Don't hurry, don't worry. You're only here for a short visit — so don't forget to stop and smell the flowers.", who: "Walter Hagen" },
    { text: "A bad day on the golf course still beats a good day at the office.", who: "" },
    { text: "I'm not over the hill — I'm just on the back nine.", who: "" },
    { text: "If profanity had any influence on the flight of the ball, golf would be played far better than it is.", who: "Horace Hutchinson" },
    { text: "A champion is afraid of losing. Everyone else is afraid of winning.", who: "Gary Player" },
    { text: "Golf is a puzzle without an answer. I've played the game for 50 years and I still haven't found the answer.", who: "Gary Player" },
    { text: "The greatest thing about tomorrow is, I will be better than I am today.", who: "Tiger Woods" },
    { text: "No matter how good you get, you can always get better — and that's the exciting part.", who: "Tiger Woods" },
    { text: "I want to be the best of my generation. That's a way of moving forward.", who: "Rory McIlroy" },
    { text: "I'm a shy person — I don't really like to be the centre of attention.", who: "Rory McIlroy" },
    { text: "I want to push the boundaries of golf and bring something different to the game.", who: "Bryson DeChambeau" },
    { text: "Golf is a game of misses. The man who misses the best is the winner.", who: "Ben Hogan" },
    { text: "The secret is in the dirt.", who: "Ben Hogan" },
  ];
